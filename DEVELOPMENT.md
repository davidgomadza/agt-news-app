...
```bash
git remote add encore encore://agt-news-app-i9ui
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/agt-news-app-i9ui/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/agt-news-app-i9ui/settings/integrations/github)
